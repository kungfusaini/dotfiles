...
const body_componentClassPrefix = "notification-confirmation-body";
...
const iconContainerStyles = (error) => body_css `
  > svg {
    width: ${!error ? "50px" : "40px"};
    height: auto;
  }
`;
const notificationConfirmationBodyStyles = ({ theme }) => body_css `
  gap: ${spacing[4]};
  display: flex;
  align-items: center;
  justify-content: flex-start;
...
function NotificationConfirmationContainer({ error, handleCloseNotification, handleOpenVault, handleOpenTasks, i18n, itemName, task, theme = ThemeTypes.Light, type, }) {
...
function OptionItem({ contextLabel, icon, text, theme, value, handleSelection, }) {
...
function OptionItems({ theme, topOffset, label, options, handleOptionSelection, }) {
    ...
    >
      ...
      <div class=${optionsWrapper({ isSafari, theme })}>
        ${options.map((option) => OptionItem(Object.assign(Object.assign({}, option), { theme, contextLabel: label, handleSelection: () => handleOptionSelection(option) })))}
      </div>
    </div>
  `;
}
...
function NotificationFooter({ collections, folders, i18n, notificationType, organizations, personalVaultIsAllowed, theme, handleSaveAction, }) {
...
function NotificationContainer({ handleCloseNotification, handleEditOrUpdateAction, handleSaveAction, ciphers, collections, folders, i18n, organizations, personalVaultIsAllowed = true, theme = ThemeTypes.Light, type, }) {
...
function initNotificationBar(message) {
    return bar_awaiter(this, void 0, void 0, function* () {
        ...
        if (useComponentBar) {
            ...
            if (isVaultLocked) {
                return B(NotificationContainer(Object.assign(Object.assign({}, notificationBarIframeInitData), { type: NotificationTypes.Unlock, theme: resolvedTheme, personalVaultIsAllowed: !personalVaultDisallowed, handleCloseNotification, handleSaveAction: (e) => {
            ...
            yield Promise.all([
                ...
                return B(NotificationContainer(Object.assign(Object.assign({}, notificationBarIframeInitData), { type: notificationBarIframeInitData.type, theme: resolvedTheme, personalVaultIsAllowed: !personalVaultDisallowed, handleCloseNotification,
                    handleSaveAction,
                    handleEditOrUpdateAction,
                    i18n })), document.body);
            });
...
function handleSaveCipherConfirmation(message) {
    ...
    return B(NotificationConfirmationContainer(Object.assign(Object.assign({}, notificationBarIframeInitData), { type: type, theme: resolvedTheme, handleCloseNotification,
        i18n,
        error, itemName: itemName !== null && itemName !== void 0 ? itemName : i18n.typeLogin, task, handleOpenVault: (e) => cipherId ? openViewVaultItemPopout(cipherId) : openAddEditVaultItemPopout(e, {}), handleOpenTasks: () => sendPlatformMessage({ command: "bgOpenAtRisksPasswords" }) })), document.body);
}
