...
- Revert [#8341](https://github.com/cline/cline/issues/8341) due to regressions in diff view/document truncation (see [#8423](https://github.com/cline/cline/issues/8423), [#8429](https://github.com/cline/cline/issues/8429))
